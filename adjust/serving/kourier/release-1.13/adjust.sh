...
#Fix Kapp naming
sed -i 's|github\.com/k14s/kapp/cmd/kapp|github\.com/vmware-tanzu/carvel-kapp/cmd/kapp|g' test/e2e-common.sh
...
sed -i "/.*queue-sidecar-image.*/a\  registriesSkippingTagResolving: icr.io" config/core/configmaps/deployment.yaml
